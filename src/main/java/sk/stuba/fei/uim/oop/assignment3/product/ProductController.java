...
public class ProductController {
    ...
    public IntResponse productAmount(@PathVariable("id") Long id) throws NotFoundException {
    ...
    public IntResponse incrementAmount(@PathVariable("id") Long id, @RequestBody ProductRequest request) throws NotFoundException {
